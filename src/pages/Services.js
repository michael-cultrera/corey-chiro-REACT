...
export default function Services() {
  return (
    <Typography sx={{pt: "20px"}}>
        ...
        <Typography variant="header" sx={{ pt: 4,}}>Therapeutic Ultrasound for Chronic Pain Relief</Typography>
        ...
        <Typography variant="header" sx={{ pt: 4,}}>Instrument-Assisted Mechanical Spine Adjustments</Typography>
